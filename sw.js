const CACHE="mclay-swimming-os-v1-5-workflow-evidence";
const ASSETS=["./","./index.html","./styles.css","./config.js","./seed.js","./app.js","./manifest.webmanifest","./icon-192.png","./icon-512.png"];
