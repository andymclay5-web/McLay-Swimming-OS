...
(function(root,factory){
  ...
  function keys(prefix='msos.assembly.v1'){const p=text(prefix)||'msos.assembly.v1';return Object.freeze({schedule:`${p}.schedule`,lifecycle:`${p}.lifecycle`,attendance:`${p}.attendance`,capture:`${p}.capture`,navigation:`${p}.navigation`,resources:`${p}.resources`})}
