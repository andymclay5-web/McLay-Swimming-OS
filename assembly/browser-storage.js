...
(function(root,factory){
  ...
  function keys(prefix='msos.assembly.v1'){const p=text(prefix)||'msos.assembly.v1';return Object.freeze({schedule:`${p}.schedule`,lifecycle:`${p}.lifecycle`,attendance:`${p}.attendance`,capture:`${p}.capture`,adaptation:`${p}.adaptation`,delivery:`${p}.delivery`,timing:`${p}.timing`,protocols:`${p}.protocols`,testResults:`${p}.test-results`,navigation:`${p}.navigation`,resources:`${p}.resources`})}
