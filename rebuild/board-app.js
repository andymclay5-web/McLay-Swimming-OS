...
(function(root,factory){
  ...
  class BoardApp{
    constructor({root,runtime,openers={},getScroll=()=>0,setScroll=()=>{},onError=null}={}){
      ...
      this.root=root;this.runtime=runtime;
      this.owners=D.CommandOwners.create({runtime,openers});
