...
(function(root,factory){
  ...
  class PoolsideActions{
    ...
    times=({context,session}={})=>{const athletes=typeof this.runtime.allAthletes==='function'?this.runtime.allAthletes():this.runtime.roll().eligible||[],timingSessions=typeof this.runtime.timingSessions==='function'?this.runtime.timingSessions({}):[],testResults=typeof this.runtime.testResults==='function'?this.runtime.testResults({testKey:'t400_freestyle'}):[];return this.emit('times',{context:clone(context),session:clone(session),athletes:clone(athletes),timingSessions:clone(timingSessions),testResults:clone(testResults),t400:(athleteRef,opts={})=>this.runtime.t400Evidence(athleteRef,{course:session?.identity?.course||'',...opts}),pathway:(athleteRef,opts={})=>this.runtime.pathwayProfile(athleteRef,{course:session?.identity?.course||'',...opts}),target:(itemId,athleteRef)=>this.runtime.targetFor(itemId,athleteRef),startT400:typeof this.runtime.createT400Timing==='function'?(athleteRefs,opts={})=>this.runtime.createT400Timing(athleteRefs,{course:session?.identity?.course||'',...opts}):null,timing:typeof this.runtime.timingSession==='function'?id=>this.runtime.timingSession(id):null,startTiming:typeof this.runtime.startTiming==='function'?(id,opts={})=>this.runtime.startTiming(id,opts):null,split:typeof this.runtime.recordTimingSplit==='function'?(id,athleteRef,distance,elapsed,opts={})=>this.runtime.recordTimingSplit(id,athleteRef,distance,elapsed,opts):null,finishAthlete:typeof this.runtime.finishTimingAthlete==='function'?(id,athleteRef,elapsed,opts={})=>this.runtime.finishTimingAthlete(id,athleteRef,elapsed,opts):null,saveT400:typeof this.runtime.saveT400FromTiming==='function'?(id,athleteRef,opts={})=>this.changed(this.runtime.saveT400FromTiming(id,athleteRef,opts)):null,closeTiming:typeof this.runtime.closeTiming==='function'?(id,opts={})=>this.runtime.closeTiming(id,opts):null})}
