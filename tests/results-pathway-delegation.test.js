...
function fixture(){
 ...
 return{p:Pathway.create({evidence,standardsEngine:rules,today:()=> '2026-08-18'}),calls,athlete,pb};
}
...
test('incomplete Standards Records contract fails closed',()=>{const evidence={resolveAthlete:()=>null,results:()=>[]};assert.throws(()=>Pathway.create({evidence,standardsEngine:{}}),/contract incomplete/)});
