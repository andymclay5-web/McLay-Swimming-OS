...
assert.match(index,/app\.js\?v=20260825-board-authority-e|app\.js\?v=20260916-connection-diagnostics-a|app\.js\?v=20260916-hub-render-timing|app\.js\?v=20260916-qr-attempt-diagnostics|app\.js\?v=20260917-ladder-full-count|app\.js\?v=20260917-equipment-vocab|app\.js\?v=20260917-hash-rep-pattern|app\.js\?v=20260918-board-real-session-vocabulary/,'repaired app.js does not have a unique asset identity');
...
assert.match(sw,/app\.js\?v=20260825-board-authority-e|app\.js\?v=20260916-connection-diagnostics-a|app\.js\?v=20260916-hub-render-timing|app\.js\?v=20260916-qr-attempt-diagnostics|app\.js\?v=20260917-ladder-full-count|app\.js\?v=20260917-equipment-vocab|app\.js\?v=20260917-hash-rep-pattern|app\.js\?v=20260918-board-real-session-vocabulary/,'offline package does not pin repaired app.js identity');
