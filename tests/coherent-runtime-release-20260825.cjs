...
assert.match(index,/app\.js\?v=20260825-board-authority-e|app\.js\?v=20260916-connection-diagnostics-a|app\.js\?v=20260916-hub-render-timing/,'repaired app.js does not have a unique asset identity');
...
assert.match(sw,/app\.js\?v=20260825-board-authority-e|app\.js\?v=20260916-connection-diagnostics-a|app\.js\?v=20260916-hub-render-timing/,'offline package does not pin repaired app.js identity');
