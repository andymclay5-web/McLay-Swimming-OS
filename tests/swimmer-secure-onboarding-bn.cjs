...
assert.ok(/engines\/swimmer-invite-bn\.js\?v=20260824(?:bn|ci|cp|cu)|engines\/swimmer-invite-bn\.js\?v=20260912[bc]|engines\/swimmer-invite-bn\.js\?v=20260913c/.test(index),'coach QR engine not loaded');
