...
(function(g){
  ...
  E.t400Rows=(ath,state,wantedStroke='Freestyle')=>{try{const wanted=E.stroke(wantedStroke);return rowsFor(ath,state,'test').filter(r=>E.isT400(state,r)&&E.t400Stroke(state,r)===wanted&&r.valid_for_anchor!==false).sort((a,b)=>{const ad=E.resultDateMs(a),bd=E.resultDateMs(b);if(ad!=null||bd!=null){if(ad==null)return 1;if(bd==null)return-1;if(ad!==bd)return bd-ad;}return E.seconds(a)-E.seconds(b);})}catch{return originalT400(ath,state,wantedStroke)}};
